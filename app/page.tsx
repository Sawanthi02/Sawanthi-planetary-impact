    ...
    <>
      <main>
        ...
        <div className="flex flex-col items-center text-center text-gray-500 p-8">
          <h1 className="font-sans text-6xl p-4">&quot;Maak werk van Mars&quot;</h1>
          <p className="font-sans text-2xl">Mars is de toekomst. Planetary Impact helpt u met het zoeken naar een geschikte plek voor uw kolonie.</p>
        </div>
        ...
        <div className="mb-15 grid grid-cols-1 lg:grid-cols-2 pl-16 pr-16 pt-4 pb-4" style={{backgroundColor: "#CA433C"}}>
          <div>
